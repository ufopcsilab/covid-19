...
### Baseado no trabalho "Towards an Efficient Deep Learning Model for COVID-19 Patterns Detection in X-ray Images", disponível no [link](https://arxiv.org/pdf/2004.05717.pdf).
